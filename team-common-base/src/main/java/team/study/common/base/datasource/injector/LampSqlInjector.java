package team.study.common.base.datasource.injector;
...
import team.study.common.base.datasource.injector.method.UpdateAllById;
...
public class LampSqlInjector extends DefaultSqlInjector {
    ...
    public List<AbstractMethod> getMethodList(Class<?> mapperClass, TableInfo tableInfo) {
        ...
        methodList.add(new UpdateAllById(field -> !ArrayUtil.containsAny(new String[]{
                Entity.CREATE_TIME_COLUMN, Entity.CREATE_BY_COLUMN
        }, field.getColumn())));
        return methodList;
    }
}
