...
import team.study.common.base.uid.BitsAllocator;
import team.study.common.base.uid.UidGenerator;
import team.study.common.base.uid.buffer.BufferPaddingExecutor;
import team.study.common.base.uid.buffer.RejectedPutBufferHandler;
import team.study.common.base.uid.buffer.RejectedTakeBufferHandler;
import team.study.common.base.uid.buffer.RingBuffer;
...
public class CachedUidGenerator extends DefaultUidGenerator implements DisposableBean {
    ...
    public long getUid() {
        try {
            ...
            throw new UidGenerateException("UID异常", e);
        }
    }
