package team.study.common.interaction.handler;
...
import team.study.common.interaction.config.message.TeamMessageSource;
...
public class GlobalExceptionHandler {
    ...
    @Autowired
    private TeamMessageSource messageSource;
